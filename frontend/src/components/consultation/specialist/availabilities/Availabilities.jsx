...
function Availabilities(props) {
  ...
  const fetchAvailabilities = async () => {
    try {
      ...
      const response = await axios.get(`https://herb-care-pzwv.onrender.com/availability/getAvailabilitiesByDateAndSpecialist`, {
        params: {
          date: formattedDate,
      ...
      const availabilitiesWithCenterNames = await Promise.all(response.data.map(async availability => {
        ...
        if (availability.center === null) {
          ...
          const centerResponse = await axios.get(`https://herb-care-pzwv.onrender.com/center/${availability.center}`);
