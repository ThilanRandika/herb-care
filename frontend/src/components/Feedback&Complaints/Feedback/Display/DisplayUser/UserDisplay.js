...
const UserFeedback = ({ customerId }) => {
  ...
  const fetchFeedbacks = async () => {
    try {
      const response = await axios.get('https://herb-care-pzwv.onrender.com/feedback/get');
  ...
  const handleDelete = async (feedbackId) => {
    try {
      await axios.delete(`https://herb-care-pzwv.onrender.com/feedback/delete/${feedbackId}`);
