...
function SpecialistDashboard(props) {
  ...
  useEffect(() => {
    fetch(`https://herb-care-pzwv.onrender.com/consultAppointment/getOngoingAppointmentsCount/${user._id}`)
    ...
    fetch(`https://herb-care-pzwv.onrender.com/consultAppointment/getAllAppointmentsCount/${user._id}`)
      .then(response => response.json())
      .then(data => setAllAppointmentsCount(data.count))
      .catch(error => console.error('Error fetching all appointments count:', error));

    fetch(`https://herb-care-pzwv.onrender.com/consultAppointment/getCompletedAppointmentsCount/${user._id}`)
      .then(response => response.json())
    ...
    fetch(`https://herb-care-pzwv.onrender.com/consultAppointment/getTodaysAppointmentsCount/${user._id}`)
      .then(response => response.json())
