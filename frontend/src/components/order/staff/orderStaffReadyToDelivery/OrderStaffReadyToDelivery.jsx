...
import './orderStaffReadyToDelivery.css';
import axios from 'axios';
import { Link, useNavigate } from 'react-router-dom';
import config from '../../../../config';
import { AuthContext } from '../../../../context/AuthContext';

function OrderStaffReadyToDelivery() {
    ...
    useEffect(() => {
        axios.get(`${config.BASE_URL}/order/getAllReadyToDeliveryOrders`)
            .then((res)=> {
    ...
    const handleDeliveryProcess = (id)=> {
        axios.put(`${config.BASE_URL}/Order/setOrderToOnDelivery/` + id)
            .then((res) =>{
...
export default OrderStaffReadyToDelivery  