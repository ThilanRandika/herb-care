...
import EditPackages from "./components/HolidayPackage/EditPackages";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        ></Route>
        <Route
          path="/Update_default_gift_packages"
          element={<UpdateDefaultGiftPackage />}
        ></Route>

        <Route path="/holiday_packages" element={<ViewPackages />}></Route>
        <Route
          path="/create_holiday_package"
          element={<CreatePackage />}
        ></Route>
        <Route path="/package_details/:id" element={<PackageDetails />}></Route>
        <Route path="/edit_packages" element={<EditPackages />}></Route>
      </Routes>
    </BrowserRouter>
  );
}
